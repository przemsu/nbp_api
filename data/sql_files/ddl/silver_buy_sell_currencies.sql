create or replace view silver_buy_sell_currencies_rates AS 
...
and (raw_content->>'$.table')::VARCHAR = 'C'
)
select 
      endpoint_type                                                             as endpoint_type,
      extraction_date                                                           as extraction_date,
      ...
      round((rate_obj->>'$.bid')::DOUBLE, 5)                                    as bid,
      round((rate_obj->>'$.ask')::DOUBLE, 5)                                    as ask,
      round(((rate_obj->>'$.bid')::DOUBLE + (rate_obj->>'$.ask')::DOUBLE)/2,5)  as final_rate
from rates_unnested
;